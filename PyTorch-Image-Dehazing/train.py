...
def train(config):
	...
	# 										"content/drive/MyDrive/PyTorch-Image-Dehazing/data/images", mode="val")	
...
if __name__ == "__main__":
	...
	# Input Parameters
	parser.add_argument('--orig_images_path', type=str, default="/content/drive/MyDrive/PyTorch-Image-Dehazing/data/data")
	parser.add_argument('--hazy_images_path', type=str, default="/content/drive/MyDrive/PyTorch-Image-Dehazing/data/images")
	...
	parser.add_argument('--snapshots_folder', type=str, default="/content/drive/MyDrive/PyTorch-Image-Dehazing/snapshots")
	parser.add_argument('--sample_output_folder', type=str, default="/content/drive/MyDrive/PyTorch-Image-Dehazing/samples")
